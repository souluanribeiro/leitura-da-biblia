    ...
    <div className="p-4 space-y-5 max-w-lg mx-auto pb-8 fade-in">
      ...
      <div className="bg-bg-card rounded-2xl p-5 border border-white/5 space-y-4 text-sm text-text-secondary leading-relaxed">
        <p>
          ...
          na aba <span className="text-accent font-medium">"Seções"</span>. Se ler um grupo de
        ...
        <div className="space-y-2">
          <div className="flex items-start gap-2">
            ...
            <p>Leia os dias com o marcador <span className="font-semibold text-red-400">VERMELHO</span> para ter uma visão histórica geral dos tratos de Deus com os israelitas.</p>
          </div>
          <div className="flex items-start gap-2">
